...
*/
			You_hear("%s音を聞いた。",lava ? "溶岩のはねる" : "水しぶきの");
...
*/
		pline("言葉にできないほどの残虐と惨事がこの下に潜んでいる。");
/*JP
...
boolean at_stairs, falling, portal;
{
	...
	if (Inhell && up && u.uhave.amulet && !newdungeon && !portal &&
	  ...
	  /* NO MORE IRRITATING GEHENOM
		if (!rn2(4)) {
		    int odds = 3 + (int)u.ualign.type,
...
#else
		"うひゃ！何もかも違うみたいだ。",
		"あなたはまがりくねった、すべて同じに見える小径に囲まれている…",
		"げ、ここはコナンおじさんの土地のようだ…",
#endif
		0	/* no message */
	    };
