...
*/
		You("あやうく目的を達成できなくなるところだった。");
		else	/* converted */
/*JP
			You("are suddenly overcome with shame and change your mind.");
*/
			You("突然恥ずかしさに圧倒され、心を変えた。");
		u.ublessed = 0; /* lose your god's protection */
		makeknown(otmp->otyp);
		flags.botl = 1;
		return 1;
...
*/
		pline("%sがトラバサミにつかまっているので脱ぐことができない。",
			  body_part(FOOT));
		return 0;
