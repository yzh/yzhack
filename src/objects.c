...
HELM("katyusha", "headpiece",
                0, 1,  DISPLACED,       0, 0,  1, 200,10, 0, CLOTH, CLR_WHITE),
HELM("nurse cap", "white cap",
                1, 0,  0,       0, 0,  2,  10, 1, 0, CLOTH, CLR_WHITE),
...
ARMOR("elven mithril-coat", (char *)0,
	1, 0, 0, 0,	 6, 1, 150, 240,  5, 3, ARM_SUIT, MITHRIL, HI_METAL),
...
ARMOR("maid dress", "black dress",
        0, 1, 0, ANTIMAGIC,      0, 0,  20, 400,  1, 0, ARM_SUIT, CLOTH, CLR_BLACK),
ARMOR("nurse uniform", "white dress",
        0, 0, 0, 0,      0, 0,  15, 200,  1, 0, ARM_SUIT, CLOTH, CLR_WHITE),
...
CLOAK("frilled apron", "apron",
                0, 0,   POISON_RES,  0, 0,  5, 250, 1, 0, CLOTH, CLR_WHITE),
