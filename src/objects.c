...
WEAPON("dart", (char *)0,
	1, 1, 0, 50,  1,  2,  3,  2, 0, P,   -P_DART, IRON, HI_METAL),
...
/* spears */
WEAPON("spear", (char *)0,
	1, 1, 0, 45, 30,  3,  6,  8, 0, P,   P_SPEAR, IRON, HI_METAL),
...
WEAPON("trident", (char *)0,
	1, 0, 0,  8, 25,  5,  6,  4, 0, P,   P_SPEAR, IRON, HI_METAL),
						/* +1 small, +2d4 large */
...
WEAPON("scalpel", (char *)0,
	1, 1, 0,  0,  5,  6,  3,  3, 2, S,   P_DAGGER, METAL, HI_METAL),
WEAPON("knife", (char *)0,
	1, 1, 0, 15,  5,  4,  3,  2, 0, P|S, P_DAGGER, IRON, HI_METAL),
WEAPON("stiletto", (char *)0,
	1, 1, 0,  5,  5,  4,  3,  2, 0, P|S, P_DAGGER, IRON, HI_METAL),
WEAPON("worm tooth", (char *)0,
	1, 0, 0,  0, 20,  2,  2,  2, 0, 0,   P_DAGGER, 0, CLR_WHITE),
WEAPON("crysknife", (char *)0,
	1, 0, 0,  0, 20,100, 10, 10, 3, P,   P_DAGGER, MINERAL, CLR_WHITE),
...
WEAPON("elven short sword", "runed short sword",
	0, 0, 0,  4, 30, 10,  8,  8, 0, P,   P_SHORT_SWORD, WOOD, HI_WOOD),
WEAPON("orcish short sword", "crude short sword",
	0, 0, 0,  4, 30, 10,  5,  8, 0, P,   P_SHORT_SWORD, IRON, CLR_BLACK),
WEAPON("dwarvish short sword", "broad short sword",
	0, 0, 0,  4, 30, 10,  7,  8, 0, P,   P_SHORT_SWORD, IRON, HI_METAL),
WEAPON("scimitar", "curved sword",
	0, 0, 0, 15, 40, 15,  7,  8, 0, S,   P_SABER, IRON, HI_METAL),
WEAPON("iron saber", (char *)0,
	1, 0, 0, 12, 40, 15,  8,  8, 0, S,   P_SABER, IRON, HI_METAL),
WEAPON("silver saber", (char *)0,
	1, 0, 0,  4, 40, 75,  8,  8, 0, S,   P_SABER, SILVER, HI_SILVER),
WEAPON("broadsword", (char *)0,
	1, 0, 0,  8, 70, 10,  4,  6, 0, S,   P_LONG_SWORD, IRON, HI_METAL),
						/* +d4 small, +1 large */
WEAPON("elven broadsword", "runed broadsword",
	0, 0, 0,  4, 70, 10,  6,  6, 0, S,   P_LONG_SWORD, WOOD, HI_WOOD),
						/* +d4 small, +1 large */
WEAPON("long sword", (char *)0,
	1, 0, 0, 41, 40, 15,  8, 12, 0, S,   P_LONG_SWORD, IRON, HI_METAL),
WEAPON("silver long sword", (char *)0,
	1, 0, 0,  4, 48, 75,  8, 12, 0, S,   P_LONG_SWORD, SILVER, HI_SILVER),
WEAPON("two-handed sword", (char *)0,
	1, 0, 1, 22,150, 50, 12,  6, 0, S,   P_TWO_HANDED_SWORD, IRON, HI_METAL),
						/* +2d6 large */
WEAPON("katana", "samurai sword",
	0, 0, 0,  4, 40, 80, 10, 12, 1, S,   P_LONG_SWORD, METAL, HI_METAL),
...
WEAPON("runesword", "runed broadsword",
	0, 0, 0,  0, 40,300,  4,  6, 0, S,   P_LONG_SWORD, IRON, CLR_BLACK),
						/* +d4 small, +1 large */
...
WEAPON("silver mace", (char *)0,
	1, 0, 0,  4, 36, 65,  6,  6, 0, B,   P_MACE, SILVER, HI_SILVER),
WEAPON("sword mace", (char *)0,
	1, 0, 0, 20, 33, 15,  8,  8, 0, B,   P_MACE, IRON, HI_METAL),
						/* +1 small */
WEAPON("morning star", (char *)0,
	1, 0, 0, 12,120, 10,  4,  6, 0, B,   P_MACE, IRON, HI_METAL),
						/* +d4 small, +1 large */
WEAPON("war hammer", (char *)0,
	1, 0, 0, 15, 50,  5,  4,  4, 0, B,   P_HAMMER, IRON, HI_METAL),
						/* +1 small */
WEAPON("club", (char *)0,
	1, 0, 0, 12, 30,  3,  6,  3, 0, B,   P_MACE, WOOD, HI_WOOD),
#ifdef KOPS
...
WEAPON("aklys", "thonged club",
	0, 0, 0,  8, 15,  4,  6,  3, 0, B,   P_MACE, IRON, HI_METAL),
WEAPON("flail", (char *)0,
	1, 0, 0, 40, 15,  4,  6,  4, 0, B,   P_MACE, IRON, HI_METAL),
						/* +1 small, +1d4 large */
/* misc */
...
HELM("katyusha", "headpiece",
                0, 1,  ADORNED,       0, 0,  1, 200,10, 0, CLOTH, CLR_WHITE),
HELM("nurse cap", "white cap",
                1, 0,  0,       0, 0,  2,  10, 10, 0, CLOTH, CLR_WHITE),
...
HELM("cornuthaum", "conical hat",
		0, 1,  CLAIRVOYANT,
				4, 1,  4,  80,10, 2, CLOTH, CLR_BLUE),
HELM("dunce cap", "conical hat",
		0, 1,  0,	4, 1,  4,   1,10, 0, CLOTH, CLR_BLUE),
...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	44, 5, 450, 600,  0, 2, ARM_SUIT, IRON, HI_METAL),
ARMOR("crystal plate mail", (char *)0,
	1, 0, 1, 0,	10, 5, 450, 820,  1, 2, ARM_SUIT, GLASS, CLR_WHITE),
#ifdef TOURIST
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	25, 5, 450, 400,  2, 0, ARM_SUIT, COPPER, HI_COPPER),
#else
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	35, 5, 450, 400,  2, 0, ARM_SUIT, COPPER, HI_COPPER),
#endif
ARMOR("splint mail", (char *)0,
	1, 0, 1, 0,	70, 5, 400,  80,  2, 1, ARM_SUIT, IRON, HI_METAL),
ARMOR("banded mail", (char *)0,
	1, 0, 1, 0,	72, 5, 350,  90,  3, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("dwarvish mithril-coat", (char *)0,
	1, 0, 0, 0,	 6, 1, 150, 240,  3, 3, ARM_SUIT, MITHRIL, HI_METAL),
ARMOR("elven mithril-coat", (char *)0,
	1, 0, 0, 0,	 6, 1, 150, 240,  4, 3, ARM_SUIT, MITHRIL, HI_METAL),
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	78, 5, 300,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish chain mail", "crude chain mail",
	0, 0, 0, 0,	20, 5, 300,  75,  5, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("scale mail", (char *)0,
	1, 0, 0, 0,	64, 5, 250,  45,  5, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("studded leather armor", (char *)0,
	1, 0, 0, 0,	70, 3, 200,  15,  6, 1, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("ring mail", (char *)0,
	1, 0, 0, 0,	72, 5, 250, 100,  6, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	20, 5, 250,  80,  7, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	82, 3, 150,   5,  7, 0, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("leather jacket", (char *)0,
	1, 0, 0, 0,	12, 0,	30,  10,  9, 0, ARM_SUIT, LEATHER, CLR_BLACK),
/* dress from brass ... only for joke ... */
ARMOR("maid dress", "black dress",
        0, 1, 0, ADORNED,      0, 0,  20, 400,  10, 0, ARM_SUIT, CLOTH, CLR_BLACK),
ARMOR("nurse uniform", "white dress",
        0, 0, 0, 0,      0, 0,  15, 200,  10, 0, ARM_SUIT, CLOTH, CLR_WHITE),
...
CLOAK("robe", (char *)0,
		1, 1,	0,	    5, 0, 15, 50,  8, 3, CLOTH, CLR_RED),
CLOAK("alchemy smock", "apron",
		0, 1,	POISON_RES, 8, 0, 10, 50,  9, 1, CLOTH, CLR_WHITE),
/* maid dress */
CLOAK("kitchen apron", "apron",
                0, 0,   0,          5, 0,  5, 50, 10, 0, CLOTH, CLR_WHITE),
CLOAK("frilled apron", "apron",
                0, 0,   ADORNED,  0, 0,  5, 250, 10, 0, CLOTH, CLR_WHITE),
...
GLOVES("silver gauntlets", "boxing gloves",
		0, 0,  REFLECTING, 2, 1, 16, 30,  9, 0, SILVER, CLR_BROWN),
...
AMULET("amulet of strangulation", "oval",       STRANGLED,  130),
AMULET("amulet of restful sleep", "triangular", SLEEPING,   130),
...
TOOL("orb of light", "glass orb",
				0, 0, 1, 0,  15, 20,1000, GLASS, HI_GLASS),
/* other tools */
#ifdef TOURIST
...
WEPTOOL("grappling hook", "iron hook",
	0, 0, 0,  5,  30,  50,  2,  6, WHACK,  P_MACE, IRON, HI_METAL),
...
POTION("poison", "fizzy",               0, 0,          32,  50, CLR_CYAN),
POTION("sickness", "hazy",              0, 0,          10,  50, CLR_MAGENTA),
...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("trap detection",	"FOOBIE BLETCH",	1,  25, 300),
	SCROLL("destruction",		"TEMOV",                1,  15, 100),
...
SPELL("dig",             "parchment",   P_MATTER_SPELL, 18,  6, 5, 1, RAY,       HI_PAPER),
...
SPELL("haste self",      "purple",      P_ESCAPE_SPELL, 32,  4, 3, 1, NODIR,     CLR_MAGENTA),
...
SPELL("lightning",	 "rainbow",  P_ATTACK_SPELL, 12, 10, 4, 1, RAY, HI_PAPER),
#if 0	/* DEFERRED */
...
GEM("lapis lazuri", "blue",            6,  1,  900, 15,  7, GEMSTONE, CLR_BLUE),
GEM("amber", "yellowish brown",        8,  1, 1000, 15,  2, GEMSTONE, CLR_BROWN),
GEM("topaz", "yellowish brown",        7,  1,  900, 15,  8, GEMSTONE, CLR_BROWN),
GEM("jet", "black",                    6,  1,  850, 15,  7, GEMSTONE, CLR_BLACK),
GEM("opal", "white",                   9,  1,  800, 15,  6, GEMSTONE, CLR_WHITE),
...
GEM("worthless piece of orange glass", "orange", 77, 1, 0, 6, 5, GLASS, CLR_ORANGE),
