 ...
 */
	...
	M2_HOSTILE|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_MAGENTA),
/*    MON("Wishmaster", S_HUMANOID,
	LVL(15, 12, 0, 90, -8), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_TENT, AD_DRIN, 2, 1),
	  ATTK(AT_TENT, AD_DRIN, 2, 1), ATTK(AT_TENT, AD_DRIN, 2, 1),
	  ATTK(AT_TENT, AD_DRIN, 2, 1), ATTK(AT_TENT, AD_DRIN, 2, 1)),
	SIZ(1450, 400, 0, MS_HISS, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_FLY|M1_SEE_INVIS|M1_OMNIVORE,
	M2_HOSTILE|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_COLLECT,
	M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),*/
#ifdef FELPURR
 ...
 */
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
    MON("goblin archer", S_ORC,
	LVL(2, 6, 10, 0, -3), (G_GENO|2),
 ...
 */
	...
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC,
	0, CLR_YELLOW),
    MON("skeleton dragon", S_DRAGON,
	LVL(15, 9, -1, 0, 0), (G_NOCORPSE|G_GENO|1),
	A(ATTK(AT_BITE, AD_SLOW, 1, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_DRAGON, 1500, 0, MS_BONES, MZ_GIGANTIC), MR_COLD|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS,
	M2_UNDEAD|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC, 0, CLR_WHITE),
/*
 * Elementals
 */
 ...
 */
	...
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
	M2_HOSTILE|M2_NEUTER, 0, CLR_YELLOW),
    MON("triffid", S_FUNGUS,
	LVL(5, 4, 7, 0, 0), (G_GENO|2),
	A(ATTK(AT_STNG, AD_PLYS, 1, 4), ATTK(AT_TUCH, AD_PHYS, 1, 4), 
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(20, 200, 0, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON,
 ...
 */
	...
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC, M3_WANTSBOOK|M3_INFRAVISION, HI_LORD),
/*    MON("Lawmaker", S_LICH,
	LVL(25, 9, -6, 90, -15), (G_UNIQ|G_NOGEN|G_NOCORPSE),
	A(ATTK(AT_TUCH, AD_COLD, 5, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1200, 100, 0, MS_MUMBLE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_SLEEP|MR_ELEC|MR_POISON, MR_FIRE|MR_COLD,
	...
	M3_WAITFORU|M3_WANTSBOOK|M3_INFRAVISION, HI_LORD),*/
/*
 * Mummies
 */
 ...
 */
	...
	M3_INFRAVISIBLE, CLR_BLUE),
/*    MON("Magicmaker", S_RUSTMONST,
	LVL(12, 12, -10, 0, -3), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_ENCH, 4, 4), ATTK(AT_NONE, AD_ENCH, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(750, 200, 0, MS_GROWL, MZ_LARGE), 0, 0,
	M1_ANIMAL|M1_CARNIVORE, 
	M2_HOSTILE,
	M3_WAITFORU|M3_INFRAVISIBLE, CLR_BLUE),*/
/*
 * Snakes
 */
 ...
 */
    ...
    MON("maid", S_HUMAN,
	LVL(1, 12, 10, 0, 0), G_NOGEN,
	A(ATTK(AT_CLAW, AD_PHYS, 1, 2), ATTK(AT_GAZE, AD_STUN, 1, 2),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_MAID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_FEMALE|M2_PEACEFUL|M2_COLLECT|M2_JEWELS,
    ...
    MON("Elvenarcher", S_HUMAN,
	LVL(7, 12, 10, 10, -6), (G_GENO|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_COLLECT, M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
 ...
 */
	...
	M2_HOSTILE, 0, CLR_BLUE),
    MON("moat monster", S_EEL,
	LVL(4, 8, 4, 0, 0), (G_GENO|G_NOGEN|G_SGROUP),
	...
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_SLITHY|M1_NOLIMBS|
	  M1_CARNIVORE|M1_OVIPAROUS|M1_NOTAKE,
	M2_HOSTILE, 0, CLR_RED),
    MON("archerfish", S_EEL,
	LVL(6, 12, 6, 0, 0), (G_GENO|G_NOGEN|G_SGROUP),
	A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_BREA, AD_ACID, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(60, 30, 0, MS_SILENT, MZ_SMALL), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_SLITHY|M1_NOLIMBS|
	  M1_CARNIVORE|M1_OVIPAROUS|M1_NOTAKE,
...
/*      evil coins        */
	...
	LVL(1, 0, 7, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|3),
	A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_BREA, AD_FIRE, 1, 1),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(8, 1, 7, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|3),
	A(ATTK(AT_BITE, AD_PHYS, 3, 6), ATTK(AT_BREA, AD_FIRE, 2, 1),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, 0, MS_SILENT, MZ_SMALL), 0, 0,
	M1_BREATHLESS|M1_NOEYES|M1_NOHEAD|M1_MINDLESS|
	M1_NOLIMBS|M1_CARNIVORE, M2_HOSTILE, 0, CLR_YELLOW),
    MON("huge pile of killer coins", S_BAD_COINS,
	LVL(12, 1, 7, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|3),
	A(ATTK(AT_BITE, AD_PHYS, 4, 6), ATTK(AT_BREA, AD_FIRE, 2, 1),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, 0, MS_SILENT, MZ_SMALL), 0, 0,
	M1_BREATHLESS|M1_NOEYES|M1_NOHEAD|M1_MINDLESS|
	M1_NOLIMBS|M1_CARNIVORE, M2_HOSTILE, 0, CLR_YELLOW),
