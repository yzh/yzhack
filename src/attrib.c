...
*/
	"強靱だ","利口だ","賢明だ","機敏だ","頑丈だ","魅力的だ"
},
		* const minusattr[] = {
/*JP
	"weak", "stupid", "foolish", "clumsy", "fragile", "repulsive"
*/
	"虚弱だ","愚かだ","間抜けだ","不器用だ","脆弱だ","醜悪だ"
};
