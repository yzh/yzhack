 ...
 *	for M2_ORC monsters.
 */
/* Sting can't be named... */
A("Sting",			ELVEN_SHORT_SWORD,
	(SPFX_RESTR|SPFX_XRAY), 0, 0,
	PHYS(8,12),	NO_DFNS,	NO_CARY,	0, A_CHAOTIC, NON_PM, PM_ELF, 800L ),
/*
...
A("Sunflower Aegis", SHIELD_OF_REFLECTION,
	(SPFX_RESTR|SPFX_HALRES|SPFX_REFLECT), SPFX_HPHDAM, 0,
	NO_ATTK,      DFNS(AD_BLND),        NO_CARY,
...
A("The Holy Dagger",			ATHAME,
	...
	PHYS(3,4),	NO_DFNS,	CARY(AD_MAGM),
	0,	A_LAWFUL, PM_MEDIUM, NON_PM, 2500L ),
...
*/
A("The Butterfly Knife", DAGGER,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL|SPFX_BEHEAD), 0, 0,
	PHYS(8,12),	NO_DFNS,	NO_CARY,
	UNTRAP,		A_CHAOTIC, PM_ROGUE, NON_PM, 3500L),
