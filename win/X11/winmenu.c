...
#else
	cancel = XtCreateManagedWidget("キャンセル",
#endif
			commandWidgetClass,
			form,
			args, num_args);
...
#else
	all = XtCreateManagedWidget("すべて選択",
#endif
			commandWidgetClass,
			form,
			args, num_args);
...
#else
	none = XtCreateManagedWidget("すべて解除",
#endif
			commandWidgetClass,
			form,
			args, num_args);
...
#else
	invert = XtCreateManagedWidget("反転",
#endif
			commandWidgetClass,
			form,
			args, num_args);
...
#else
	search = XtCreateManagedWidget("検索",
#endif
			commandWidgetClass,
			form,
			args, num_args);
