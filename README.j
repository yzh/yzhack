...
JNetHack is Japanization of Nethack-3.4.3. You must read
...
JNetHackは NetHack-3.4.3に日本語化を施したものです．JNetHackを再配布する
際はオリジナルのNetHack-3.4.3のライセンス (dat/license)をよく読んでくだ
